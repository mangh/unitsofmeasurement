...
namespace Demo.UnitsOfMeasurement
{
    public partial struct Centimeter : IQuantity<double>, IEquatable<Centimeter>, IComparable<Centimeter>, IFormattable
    {
        ...
        {
            if (q.Unit.Family != Centimeter.Family)
            {
				throw new InvalidOperationException(string.Format("Cannot convert \"{0}\" to \"Centimeter\"", q.GetType().Name));
            }
        ...
        {
            return string.Format(fp, format ?? Centimeter.Format, q, Centimeter.Symbol.Default);
        }
        ...
        public static readonly SymbolCollection Symbol = new SymbolCollection("cm");
        public static readonly Unit<double> Proxy = new Centimeter_Proxy();
        public const double Factor = 100d * Meter.Factor;
        public static string Format { get { return s_format; } set { s_format = value; } }
        private static string s_format = "{0} {1}";
        #endregion

        #region Predefined quantities
        public static readonly Centimeter One = new Centimeter(1d);
        public static readonly Centimeter Zero = new Centimeter(0d);
        #endregion
    }
    ...
    public partial class Centimeter_Proxy : Unit<double>
    {
        ...
        public override double Factor { get { return Centimeter.Factor; } }
