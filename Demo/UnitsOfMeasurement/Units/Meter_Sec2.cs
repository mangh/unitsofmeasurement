...
namespace Demo.UnitsOfMeasurement
{
    public partial struct Meter_Sec2 : IQuantity<double>, IEquatable<Meter_Sec2>, IComparable<Meter_Sec2>, IFormattable
    {
        ...
        {
            if (q.Unit.Family != Meter_Sec2.Family)
            {
				throw new InvalidOperationException(string.Format("Cannot convert \"{0}\" to \"Meter_Sec2\"", q.GetType().Name));
            }
        ...
        {
            return string.Format(fp, format ?? Meter_Sec2.Format, q, Meter_Sec2.Symbol.Default);
        }
        ...
        public static readonly Dimension Sense = Meter_Sec.Sense / Second.Sense;
        public const int Family = 14;
        public static readonly SymbolCollection Symbol = new SymbolCollection("m/s2");
        public static readonly Unit<double> Proxy = new Meter_Sec2_Proxy();
        public const double Factor = Meter_Sec.Factor / Second.Factor;
        public static string Format { get { return s_format; } set { s_format = value; } }
        private static string s_format = "{0} {1}";
        #endregion

        #region Predefined quantities
        public static readonly Meter_Sec2 One = new Meter_Sec2(1d);
        public static readonly Meter_Sec2 Zero = new Meter_Sec2(0d);
        #endregion
    }
    ...
    public partial class Meter_Sec2_Proxy : Unit<double>
    {
        ...
        public override double Factor { get { return Meter_Sec2.Factor; } }
