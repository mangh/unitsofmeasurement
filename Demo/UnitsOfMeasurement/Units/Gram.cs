...
{
    public partial struct Gram : IQuantity<double>, IEquatable<Gram>, IComparable<Gram>
    {
        #region Fields
        ...
        #region Formatting
        public override string ToString() { return ToString(null, Gram.Format); }
        public string ToString(string format) { return ToString(null, format); }
        public string ToString(IFormatProvider fp) { return ToString(fp, Gram.Format); }
        public string ToString(IFormatProvider fp, string format) { return String.Format(fp, format, Value, Gram.Symbol[0]); }
        #endregion
