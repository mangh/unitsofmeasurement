...
{
    public partial struct DegFahrenheit : IQuantity<double>, IEquatable<DegFahrenheit>, IComparable<DegFahrenheit>
    {
        #region Fields
        ...
        #region Formatting
        public override string ToString() { return ToString(null, DegFahrenheit.Format); }
        public string ToString(string format) { return ToString(null, format); }
        public string ToString(IFormatProvider fp) { return ToString(fp, DegFahrenheit.Format); }
        public string ToString(IFormatProvider fp, string format) { return String.Format(fp, format, Value, DegFahrenheit.Symbol[0]); }
        #endregion
